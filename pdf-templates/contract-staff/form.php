...
<form action="pdf-templates/contract-staff/pdf-creator.php" method="POST" target="_blank">
<input type="hidden" name="doc-name" value="Työsopimus <?php echo $user->name[0]; ?>"><br>
