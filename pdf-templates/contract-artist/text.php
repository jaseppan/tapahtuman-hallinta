...
if($feeMethod=="verokortti") {
	$text[$x]['text'] = "<p><b>Taiteilija / Taiteilijaryhmä</b></p>";
	$text[$x]['text'] .= "<table>
...
$text[$x]['text'] = "<p>Tämä sopimus koskee Taiteilijan esiintymistä Musiikkiyhdistys Pro Sommelo ry:n järjestämässä konsertissa.
Jäljempänä sopimuksessa näihin viitataan sanalla esiintyminen:</p><p>$eventText</p>";
$text[$x]['type'] = "textarea";
...
$signatureLabel['employer']['text'] = "Maari Kallberg,<br> Pro Sommelo, taiteellinen johtaja";
